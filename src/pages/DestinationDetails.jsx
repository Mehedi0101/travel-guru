...
const DestinationDetails = () => {
    ...
    return (
        <div style={bgImg} className="min-h-screen">
            <div className="flex flex-col lg:flex-row gap-6 items-center mx-4 md:mx-8 lg:mx-14 xl:mx-20 min-h-screen pt-28 pb-10">
                <div className="text-white">
                    <h1 className='xl:text-7xl lg:text-6xl md:text-5xl text-4xl font-bebas'>{title}</h1>
                    <p className="text-sm lg:text-base">{description}</p>
                </div>
                <form className="bg-white p-5 rounded w-fit" onSubmit={handleStartBooking}>
                    ...
                    <div className="flex flex-col sm:flex-row mb-5">
                        <div>
                            ...
                            <br />
                            <input className="font-bold text-black px-5 py-2 outline-none w-full" type="date" name="from" id="from" required />
                        </div>
                        <div>
                            <label className="text-[#818181] font-medium mb-2" htmlFor="to">To</label>
                            <br />
                            <input className="font-bold text-black px-5 py-2 outline-none w-full" type="date" name="to" id="to" required />
                        </div>
                    </div>
