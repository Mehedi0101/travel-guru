...
const Place = ({ place }) => {
    ...
    return (
        <div className='text-white'>
            ...
            <button className='flex items-center gap-1 px-5 py-2 bg-primary rounded text-black active:scale-95 transition-transform mt-5 max-[700px]:mx-auto font-medium'>Booking<BsArrowRight/></button>
        </div>
    );
};
